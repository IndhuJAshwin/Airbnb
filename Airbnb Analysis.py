...
st.set_page_config(page_title="AirBnb-Analysis by INDHUMATHI!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\indhu\OneDrive\Desktop\Data Science\project-AirBnb")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"indhumathi"}')
    mail = (f'{"Mail :"}  {"indhu.jagadeeswaran@gmail.com"}')
